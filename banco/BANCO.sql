...
SELECT NOME FROM USUARIO WHERE EMAIL IN (SELECT EMAIL FROM USUARIO_PAGINA);

SELECT NOME FROM USUARIO WHERE EMAIL IN (SELECT EMAIL FROM USUARIO_GRUPO);

SELECT NOME FROM USUARIO WHERE EMAIL IN (SELECT EMAIL FROM USUARIO_EVENTO);
